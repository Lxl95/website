  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-table v-loading="listLoading" element-loading-text="拼命加载中" stripe :data="tableData" border style="width: 100%"
        ...
        <el-table-column align="center" prop="title" label="工具名称" width="200" />
        <el-table-column align="center" prop="tooltype" label="工具类型" width="120" />
        <el-table-column align="center" prop="description" show-overflow-tooltip label="简介" />
        <el-table-column align="center" prop="toolsize" label="文件大小" width="100" />

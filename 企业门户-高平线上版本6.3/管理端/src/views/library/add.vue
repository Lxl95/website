  ...
  <div class="container">
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item>
        ...
        <el-button v-if="!paramsId" @click="resetForm('form')">重 置</el-button>
        <router-link :to="{path: 'library-list'}"><el-button v-if="paramsId">返 回</el-button></router-link>
      </el-form-item>
    </el-form>
  </div>
</template>

  ...
  methods: {
    ...
    async openEdital2() {
      ...
      if (this.listData.length > 0) {
        ...
        this.form.content = await this.getNewContent(this.listData[0].id);
      } else {
        this.form.id = "";
        this.form = {
          title: "",
    ...
    async openEdital(data) {
      ...
      this.isList = false;
      this.contentInfo = true;
      this.form.content = await this.getNewContent(data.id);
    },
    openDel2(data) {

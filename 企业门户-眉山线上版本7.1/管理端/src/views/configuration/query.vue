      ...
      <div ref="formBox">
        <el-form ref="params" :inline="true" :model="params" size="small">
          ...
          <el-form-item label="生产日期" prop="year">
            <el-date-picker v-model="value2" type="daterange" align="right" unlink-panels style="width:200px"
              range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" />
          </el-form-item>
          <el-form-item label="派发状态" prop="title">
            <el-select v-model="params.isreddistribute" placeholder="请选择">
              <el-option v-for="item in options" :key="item.value" style="width:260px" :label="item.label"
                :value="item.value" />
            </el-select>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" icon="el-icon-search" @click="searchClick">查 询</el-button>
            <el-button plain type="primary" icon="el-icon-refresh" @click="reloadClick('params')">重 置</el-button>
          </el-form-item>
        </el-form>
      </div>
      <el-table ref="goodsDetailTable" v-loading="listLoading" element-loading-text="拼命加载中" stripe :data="tableData"
        border style="width: 100%" :header-cell-style="{background:'#F8F8F9',color:'#606266'}" :height="tableHeight">
        <el-table-column type="index" align="center" label="序号" width="60" />
        <el-table-column align="left" prop="qrcodenum" label="二维码序号" show-overflow-tooltip />
        <el-table-column align="left" prop="meternumber" label="表号" show-overflow-tooltip />
        <el-table-column align="left" prop="metermodel" label="表型号" show-overflow-tooltip />
        <!-- <el-table-column align="left" prop="metermodel" label="表具单位" show-overflow-tooltip /> -->
        <el-table-column align="left" label="红包派发">
        ...
        <el-table-column align="left" prop="uploadtime" label="绑定日期" show-overflow-tooltip />
      ...
      <el-dialog :title="lookForm.title" :visible.sync="dialogVisible" width="50%" center>
        <el-form ref="addForm" label-width="120px" :rules="dialogFormRules">
          ...
          <el-form-item label="绑定日期">
            <el-date-picker v-model="lookForm.producetime" align="right" type="date" style="width:20vw"

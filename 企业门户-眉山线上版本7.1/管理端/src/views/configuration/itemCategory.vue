<template>
  ...
  <el-container>
    ...
    <el-main v-loading="loading" style="margin-left:10px">
      <el-tabs type="border-card" style="height:100%;padding-top: 10px">
        <el-tab-pane label="基本信息">
          ...
          >
            ...
            <br v-if="isUrl" />
            <el-form-item v-if="!isUrl" label="展示模式" prop="istabulation">
            ...
            <div class="form-btn">
              <el-button type="primary" @click="submit('refForm')"
                >保 存</el-button
              >
              <el-button @click="resetForm('refForm')" type="primary" plain
                >重 置</el-button
              >
            </div>
          </el-form>

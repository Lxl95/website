<template>
  <el-container>
    <el-main>
      ...
      <el-table ref="userTable" v-loading="listLoading" element-loading-text="拼命加载中" :data="tableData" border stripe
        :header-cell-style="{background:'#F8F8F9',color:'#606266'}" style="width: 100%" :height="tableHeight">
        <el-table-column prop="username" label="用户名" align="left" />
        <el-table-column prop="linkman" label="联系人" align="left" />
        <el-table-column prop="mobile" label="手机号" align="left" />
        <el-table-column label="操作" align="left" width="300">
          <template slot-scope="scope">
            <el-button size="mini" type="warning" @click="handleAuth(scope.row)">权限</el-button>
      ...
      <el-pagination layout="total, sizes, prev, pager, next, jumper" background :total="total" :page-size="params.size"
        :current-page="params.page" :page-sizes="[10, 15, 20]" style="margin-top:20px;"
        @current-change="handleCurrentChange" @size-change="handleSizeChange" />
    </el-main>
    <!-- 添加对话框 -->
    <el-dialog title="会员信息" :close-on-click-modal="false" :visible.sync="addFormDialog" width="35%"
      @close="dialogClose">

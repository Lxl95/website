        ...
        <el-form-item label="上传视频" style="width: 100%;">
          ...
          >
            <el-button
              ...
              >选取视频</el-button
            >
            <span class="el-upload__tip" style="margin-left:10px;color: red">
              格式推荐MP4，文件大小不超过200MB
            </span>
          </el-upload>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        videoTitle: [
          { required: true, trigger: "blur", message: "请输入视频标题" }
        ],

  ...
  <el-container>
    ...
    <el-main>
      ...
      <el-table v-loading="listLoading" element-loading-text="拼命加载中" stripe :data="tableData" border style="width: 100%"
        ...
        <el-table-column align="left" label="封面图" width="200">
          <template slot-scope="scope">
            <el-image style="width: 160px; height: 80px" :src="scope.row.picurl" fit="cover" />
          </template>
        </el-table-column>
        <el-table-column align="left" prop="title" label="标题" width="200" />
        <el-table-column align="left" prop="description" show-overflow-tooltip label="描述" />
        <el-table-column align="left" label="是否转载" width="100">
          <template slot-scope="scope">
            {{ scope.row.isreprint == '1' ? '是' : '否' }}
          </template>
        </el-table-column>
        <el-table-column align="left" prop="librarysize" label="文件大小" width="100" />
        <el-table-column align="left" :formatter="dateFormatter" label="发布时间" width="200" />
        <el-table-column label="操作" align="left" width="200">
          <template slot-scope="scope">
            <router-link :to="{path: 'library-edit', query: {id: scope.row.id}}">

  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: 204,
        path: "recommendNews",
        component: () => import("@/views/newsManagement/recommendNews"),
        name: "推荐新闻",
    ...
    children: [
      {
        ...
        component: () => import("@/views/videoManagement/promotionalVideo"),
        name: "宣传视频",
    ...
    children: [
      {
        id: 801,
        path: "loginLog",
        component: () => import("@/views/OnlineBusinessHall/loginLog"),
        name: "操作日志",
      ...
      },
      {
        id: 802,
        path: "loginAccount",
        component: () => import("@/views/OnlineBusinessHall/loginAccount"),
        name: "用户信息管理",
      ...
      },
      {
        id: 803,
        path: "moduleConfig",
        component: () => import("@/views/OnlineBusinessHall/moduleConfig"),
        name: "业务菜单",
        meta: { title: "业务菜单", noCache: true }
      }
    ]
  },
  {

...
export const asyncRoutes = [{
        ...
        children: [{
                ...
                path: 'swiper',
                component: () =>
                    import ('@/views/configuration/swiper'),
                name: '轮播图',
...

            {
                ...
                path: 'activityModule',
                component: () =>
                    import ('@/views/configuration/activityModule'),
                name: '活动管理',
            ...
            },
            {
                ...
                path: 'sysinfo',
                component: () =>
                    import ('@/views/configuration/sysinfo'),
                name: '企业信息',
    ...
    },
    {
        ...
        children: [{
                ...
                path: 'itemCategory',
                component: () =>
                    import ('@/views/configuration/itemCategory'),
                name: '网站目录',
            ...
            },
            {
                ...
                path: 'contentColumn',
                component: () =>
                    import ('@/views/configuration/contentColumn'),
                name: '新闻管理',
                ...
                path: 'newsList',
                component: () =>
                    import ('@/views/newsManagement/newsList'),
                name: '热点新闻',
                meta: { title: '热点新闻', noCache: true }
            },{
                id: 204,
                path: 'recommendNews',
                component: () =>
                    import ('@/views/newsManagement/recommendNews'),
                name: '推荐新闻',
                meta: { title: '推荐新闻', noCache: true }
            }
        ]
    },
    {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/businessManagement/businessHandling'),
            name: '业务办理',
    ...
    },
    {
        ...
        component: Layout,
        redirect: '/videoManagement/businessHandling',
        name: '视频管理',
        meta: {
            title: '视频管理',
            icon: 'international'
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/videoManagement/promotionalVideo'),
            name: '宣传视频',
            meta: { title: '宣传视频', noCache: true }
        }]
    },
    {
        id: 5,
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/announcements/announcementType'),
            name: '公告类型',
            ...
            component: () =>
                import ('@/views/announcements/announcementQuery'),
            name: '公告查询',
...
router.beforeEach(async(to, from, next) => {
    ...
    const acctoken = GetQueryString('accessToken') || getToken()
    if (acctoken) {
        store.dispatch('user/setToken', acctoken)
        setToken(acctoken)
    }

...
$("#agreement").click(function () {
    ...
    layer.open({
        ...
        content: '尊敬的客户: <p class="agreement">感谢您注册使用我公司网上营业厅。网上营业厅的所有权和运作权，以及受理具体业务的经营权归南京水务集团有限公司所有。在注册使用本网站之前，您必须完全同意以下所有服务条款：</p> <p class="agreement"> 一、定义 </p> <p class="agreement">1、 本网站：指南京水务集团有限公司网站，网址为www.jlwater.com。</p> <p class="agreement"> 2、 用户/您：指同意并遵守本协议，完成本网站所有注册程序并经本网站确认，拥有本网站登录帐号和密码的自然人、法人、其他组织。</p> ' +

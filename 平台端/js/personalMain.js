  ...
  $(function () {
    ...
    $('#page-title').click(function () {
      if ($('.head-phone').hasClass('hasleft')) {
        ...
        $('.head-phone').removeClass('hasleft')
        $('.head-phone').animate({ left: '0px' }, 500, function () {
...
function changeNavTheme(theme) {
  // var colorList = ['#1a1a1a', '#1a1a1a', 'rgba(255,255,255,0.7)', '#1a1a1a']
  var backgroundColorList = ['#fff', '#0a7be0', '#1e1e1e', '#4dc0b3']
  $('#header').css('background', backgroundColorList[theme])
  // $('#header').css('color', colorList[theme])
}
